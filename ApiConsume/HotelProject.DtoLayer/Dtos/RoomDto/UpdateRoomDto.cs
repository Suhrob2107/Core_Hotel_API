...
namespace HotelProject.DtoLayer.Dtos.RoomDto
{
    public class UpdateRoomDto
    {
        ...
        [Required(ErrorMessage = "Lutfen oda resmini giriniz")]
        ...
        [Required(ErrorMessage = "Lutfen metrekare bilgisini giriniz")]
        public string Wifi { get; set; } = string.Empty;
        [Required(ErrorMessage = "Lutfen aciklama bilgisini giriniz")]
